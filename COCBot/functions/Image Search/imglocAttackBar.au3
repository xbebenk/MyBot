...
Func TestImglocTroopBar2()
	$g_bRunState = True
	$g_iDebugSetlog = 1
	$g_iDebugOcr = 1
	$g_iDebugImageSave = 1
	local $dragdistance = Int(GUICtrlRead($g_hTxtTestFindButton))
	local $dragdistance1 = Int(GUICtrlRead($g_hTxtTestFindButton1))
	Setlog("=========== Imgloc ============")
	ClickDrag(250 + (5 * 73), 660, 250, 660, 200)
	;ClickDrag(500 - $dragdistance, 660, 500, 660, 200)
	ClickDrag(500 - ($dragdistance - $dragdistance1), 660, 500, 660, 200)
	PrepareAttack($DB, True)
	$g_iDebugSetlog = 0
	$g_iDebugOcr = 0
	$g_iDebugImageSave = 0
	$g_bRunState = False
EndFunc   ;==>TestImglocTroopBar2
